   ...
   <div class="container">
         ...
         <%if(total_count>0){ %>
            ...
            %>
               ...
               <tr>
                  ...
                  <div>
                     <button type="button" class="btn btn-default btn-sm" OnClick="send_cart('<%=product_idx%>');">장바구니 담기</button>
                 </div>    
                 <div>
                     <button type="button" class="btn btn-danger btn-sm" OnClick="send_order('<%=product_idx%>');">바로구매</button>
                 </div>
                  </td>
               </tr>
      ...
      <div class="text-center" >
         ...
         <nav>
           <ul class="pagination">
             <li>
               <a href="/product_frontend_list_default.do?current_page=1" aria-label="Previous">
            ...
            <%for(int i=0;i<total_page;i++){ %>
               <%if(current_page==i+1){ %>
                  <li class="active"><a href="/product_frontend_list_default.do?current_page=<%=i+1%>"><%=i+1 %></a></li>
               <%}else{ %>
                  <li><a href="/product_frontend_list_default.do?current_page=<%=i+1%>"><%=i+1 %></a></li>
               <%} %>
            <%} %>

             <li>
               <a href="/product_frontend_list_default.do?current_page=<%=total_page%>" aria-label="Next">
